...
<div
	class="flex flex-col border border-fuchsia-400 sm:p-10 p-2 rounded-lg bg-fuchsia-200/10 backdrop-blur-lg h-2/3 overflow-y-scroll"
>
	{#each leaderboard.sort((user1, user2) => {
		...
		<div class="flex justify-start items-center sm:gap-10 gap-2">
